	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			...
			<ul class="nav navbar-nav">
				<li><a href="profile.php"><span class="glyphicon glyphicon-home"></span>Trang Chủ</a></li>
								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>Tên SP</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													<tr><td>Giá SP</td><td><b><?php echo  CURRENCY." ".$row["product_price"]; ?></b></td></tr>
													<tr><td>Số Lượng</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
													<tr><td>MÃ Đơn Hàng</td><td><b><?php echo $row["trx_id"]; ?></b></td></tr>
												</table>
											</div>
										</div>
									<?php
